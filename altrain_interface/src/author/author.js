...
export default function AuthoringInterface({state, ...props}) {
  ...
  return (
      <div 
        ...
        <CTATTutorWrapper 
          prob_config={{"HTML": "../model/HTML/MultiColumnArithmatic.html"}}
          style={{position:"absolute", top:340, left:450, zIndex: 0}}/>
        <StateOverlayLayer parentRef={ref} state={state} style={{position:"absolute", top:340, left:450, zIndex: 1}}/>
