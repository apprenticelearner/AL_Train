...
extern double V2Dot(Vector2 *a,Vector2 *b), V2DistanceBetween2Points(Vector2 *a,Vector2 *b); 
extern Vector2 *V2Negate(Vector2 *a), *V2Normalize(Vector2 *a);
extern Vector2 *V2Scale(Vector2 *a, double newlen), *V2Add(Vector2 *a, Vector2 *b, Vector2 *c), *V2Sub(Vector2 *a, Vector2 *b, Vector2 *c);
